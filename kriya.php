...
<body>
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            if(isset($_GET['search'])){
                $search = $_GET['search'];
                $queryKriya = "SELECT * FROM tb_umkm WHERE kategori = 'kriya' AND nama LIKE '%$search%' ORDER BY nama $sort_order";
            } else {
                $queryKriya = "SELECT * FROM tb_umkm WHERE kategori = 'kriya' ORDER BY nama $sort_order";
            }

            $resultKriya = $conn->query($queryKriya);

            if ($resultKriya->num_rows > 0) {
                while ($rowKriya = $resultKriya->fetch_assoc()) {
            ?>
                    <div class="col-md-3">
                        <a href="detail_umkm.php?id=<?php echo $rowKriya['id_umkm']; ?>" class="card-link">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <h3 class="card-title text-truncate"><?php echo $rowKriya['nama']; ?></h3>
                                </div>
                            </div>
                        </a>
                    </div>
            <?php
                ...
                echo "Tidak ada UMKM Kriya yang ditemukan.";
            }
    ...
    <div class="container mt-3">
        <form action="kriya.php" method="GET">
